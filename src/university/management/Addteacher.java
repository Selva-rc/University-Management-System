...
public class Addteacher extends JFrame implements ActionListener{
    ...
    Addteacher(){
        ...
        lblempid.setBounds(50, 192, 130, 40);
        lblempid.setFont(new Font("serif",Font.BOLD,20));
        add(lblempid);
        
        lbelempid = new JLabel("101"+first4);
        lbelempid.setBounds(200, 200, 130, 20);
        lbelempid.setFont(new Font("serif",Font.BOLD,20));
        add(lbelempid);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==submit){
            ...
            String rollno = lbelempid.getText();
            ...
            try{
                String query ="insert into teacher values('"+name+"','"+fname+"','"+rollno+"','"+date+"','"+address+"','"+phone+"','"+mail+"','"+classx+"','"+classxii+"','"+aadhar+"','"+course+"','"+branch+"')";
